...
validate_command() {
    local cmd="${1:-}"
    local valid_commands="up down restart enter build clean status logs list run init install-agent ssh volumes compose rebuild features lifecycle environment help completion test"
